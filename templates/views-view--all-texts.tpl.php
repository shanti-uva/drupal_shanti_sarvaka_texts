	...
	<div class="attachment attachment-before">
		...
		<div class="view-all-texts-control-box">
			<div class="view-all-texts-control-box-row row">
				<div class="view-all-texts-control-box-cell-header 	view-all-texts-control-box-cell  col-xs-4">
				<?php print $header; ?>
				</div>
				<div class="view-all-texts-control-box-cell-filters view-all-texts-control-box-cell  col-xs-5 col-md-4">
				<?php print $exposed; ?>
				</div>
